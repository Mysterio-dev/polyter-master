 ...
 */
    ...
    (() => {
        ...
        ymaps.ready((function() {
            var place = new ymaps.Map("map", {
                controls: [],
                center: [ 55.860464, 48.972287 ],
                zoom: 17
            });
            var place_2 = new ymaps.Map("map-2", {
                controls: [],
                center: [ 55.542258, 37.157177 ],
                zoom: 17
            });
            var place_3 = new ymaps.Map("map-3", {
                controls: [],
                center: [ 47.268869, 39.822397 ],
                zoom: 17
            });
            var place_4 = new ymaps.Map("map-4", {
                controls: [],
                center: [ 46.339869, 48.005897 ],
                zoom: 17
            });
            let myPlacemark = new ymaps.Placemark([ 55.860464, 48.972287 ], {}, {
                hasBalloon: false,
            ...
            let myPlacemark2 = new ymaps.Placemark([ 55.542258, 37.157177 ], {}, {
                hasBalloon: false,
                hideIconOnBalloonOpen: false,
                iconLayout: "default#imageWithContent",
                iconImageHref: "img/icons/map.svg",
            ...
            let myPlacemark3 = new ymaps.Placemark([ 47.268869, 39.822397 ], {}, {
                hasBalloon: false,
                hideIconOnBalloonOpen: false,
                iconLayout: "default#imageWithContent",
                iconImageHref: "img/icons/map.svg",
            ...
            let myPlacemark4 = new ymaps.Placemark([ 46.339869, 48.005897 ], {}, {
                hasBalloon: false,
                hideIconOnBalloonOpen: false,
                iconLayout: "default#imageWithContent",
                iconImageHref: "img/icons/map.svg",
            ...
            place.geoObjects.add(myPlacemark);
            place_2.geoObjects.add(myPlacemark2);
            place_3.geoObjects.add(myPlacemark3);
            place_4.geoObjects.add(myPlacemark4);
        }));
...
***************************************************************************** */
        ...
        ymaps.ready((function() {
            var mainMap = new ymaps.Map("mainMap", {
                controls: [],
                center: [ 55.84221, 49.043563 ],
                zoom: 18
            });
            let myPlacemark5 = new ymaps.Placemark([ 55.842206, 49.044763 ], {}, {
                hasBalloon: false,
                hideIconOnBalloonOpen: false,
                iconLayout: "default#imageWithContent",
                iconImageHref: "img/icons/map.svg",
